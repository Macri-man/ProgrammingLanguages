...
// g++ -o firstprogram imguisdlglad.cpp -lSDL2 -ldl -lGL -lglad -limgui
// ./firstprogram
...
int main()
{
    ...
    SDL_Window* window = SDL_CreateWindow("SDL2 with ImGui and GLAD", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
    if (!window) {
    ...
    // Setup ImGui SDL and OpenGL3 bindings
